...
public class q10_25 {
    ...
    public static void main(String[] args) {
        ...
        String[] temp1 = MyString11.split("WordAttachedlolol", "Attached");
        for (String s : temp1) {
            System.out.println(s);
        }

        String[] temp2 = MyString11.split("Wor#dAt#tac#he#dl#ol#ol", "#");
        for (String s : temp2) {
            System.out.println(s);
        }
...
class MyString11 {
    ...
    public MyString11(String string) {
    ...
    public MyString11 substring(int begin, int end) {
        char[] s = new char[end - begin];
        for (int i = begin; i < end; i++) {
            s[i - begin] = chars[i];
        }
        return new MyString11(s);
    }

    public MyString11 toLowerCase() {
        // A = 65
        // a = 97
        ...
        return new MyString11(lowerCase);

    }

    public boolean equals(MyString11 s) {
    ...
    public static MyString11 valueOf(int i) {
        ...
        return new MyString11(number);
    }

    public static MyString11 valueOf(long i) {
    ...
    public int compare(MyString11 s) {

        return compare(new String(s.toChars()));

    }

    public MyString11 substring(int begin) {
        return substring(begin, chars.length);
    }

    public MyString11 toUpperCase() {
    ...
    public static MyString11 valueOf(boolean b) {
        return new MyString11((b) ? "true" : "false");
    }
